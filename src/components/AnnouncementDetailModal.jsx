// src/components/AnnouncementDetailModal.jsx
        ...
        <AnimatePresence>
            {isOpen && (
                ...
                <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="fixed inset-0 bg-slate-900/75 backdrop-blur-lg z-50 flex justify-center items-start p-4 pt-16 sm:pt-20 overflow-y-auto"
                    onClick={onClose}
                >
                    {/* 卡片本體：提升通透感、修正圓角問題 */}
                    <motion.div
                        ...
                        className="bg-white/90 backdrop-blur-2xl border border-white/20 rounded-2xl shadow-2xl w-full max-w-4xl flex flex-col max-h-[calc(100vh-100px)] overflow-hidden"
                    ...
                    >
                        ...
                        <div className="flex-1 p-6 md:p-8 space-y-8 overflow-y-auto">
                            ...
                            {/* --- Full Content with Table Styling --- */}
                            <div>
