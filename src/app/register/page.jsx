...
export default function Register() {
      ...
      <div className="min-h-screen flex items-center justify-center py-4 sm:py-12 px-3 sm:px-6 lg:px-8" style={{ backgroundColor: 'var(--background)' }}>
        <div className="max-w-sm sm:max-w-md w-full">
          <div className="card text-center">
            ...
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4" style={{ color: 'var(--text)' }}>
              註冊成功！
            </h2>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
                沒有收到郵件？請檢查垃圾郵件資料夾，或
                <button 
                  className="underline-extend ml-1"
  ...
  return (
    <div className="min-h-screen py-4 sm:py-12 px-3 sm:px-6 lg:px-8" style={{ backgroundColor: 'var(--background)' }}>
        ...
        <div className="card">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="terms" className="ml-2 block text-sm" style={{ color: 'var(--text)' }}>
                我同意{' '}
                <Link
                  href="/terms"
                  className="underline-extend"
                  style={{ color: 'var(--primary)' }}
                >
                  使用條款
                </Link>
